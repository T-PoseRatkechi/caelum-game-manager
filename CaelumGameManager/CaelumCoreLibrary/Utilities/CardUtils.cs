...
namespace CaelumCoreLibrary.Utilities
{
    ...
    public class CardUtils
    {
        ...
        /// <returns>If <paramref name="s"/> is a valid <seealso cref="Cards.ICardModel"/> ID.</returns>
        ...
        /// <returns><paramref name="cardFilePath"/> parsed as a new <seealso cref="ICardModel"/>.</returns>
        public static ICardModel ParseCard<T>(string cardFilePath)
        {
            var cardText = File.ReadAllText(cardFilePath);
            ICardModel card = JsonSerializer.Deserialize<ICardModel>(cardText);
